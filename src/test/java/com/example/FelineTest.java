...
public class FelineTest {
    ...
    public void eatMeat() throws Exception {
        Mockito.when(feline.getFood("Хищник")).thenReturn(List.of("Животные", "Птицы", "Рыба"));  // Создал стаб, который возвращает нужное значение для метода
        ...
        assertEquals("Проверка кем питается хищник", expected, feline.getFood("Хищник"));
